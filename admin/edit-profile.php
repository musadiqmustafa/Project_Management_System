...
if($_SESSION['accountStatus'] == 2){
	redirectTo($url."client/edit-profile.php");
}
                        ...
                        <div class="form-group row">
                         ...
                         <div class="form-group row">
                            <div class="col-md-12">
                            	...
                            	<input type="url" name="fb" placeholder="https://www.facebook.com/User Id" pattern=".*\.facebook\..*" class="form-control" value="<?php echo $user->fb;?>">
                            </div>
                         </div>
                    </div>
						<div class="col-md-12">
                            ...
                            <div class="col-md-12">
                             ...
                             <input type="text" name="address" placeholder="<?php echo $lang['This Address will reflect on your invoice also!']; ?>" class="form-control" value="<?php echo $user->address;?>">
                            </div>
                         </div>
						 </div>
