				...
				<div class="modal-header">
					...
					<div class="icons-prt">
						...
						<form action="<?php echo $url; ?>client/download_pdf.php" method="post" target="_blank" enctype="multipart/form-data">
							<input type="hidden" value="<?php if (isset($_POST['edit_id1'])) {
															echo $_POST['edit_id1'];
														} ?>" name="milestone_id" />
						...
						?>
							<table id="html-2-pdfwrapper" width="90%">
								<tr>
									...
									<td><br>
										<font size="18"><b><?php echo $lang['INVOICE']; ?></b></font>
									</td>
								</tr>
								<tr>
									<td>
									...
									<td>
										...
										<?php echo $lang['Status']; ?>: <?php if ($latestMile1->status == 0) {
																			echo '<font color="#ff0000">' . $lang['Unpaid'] . '</font>';
																		} else {
																			echo '<font color="#00c82a">' . $lang['Paid'] . '</font>';
																		} ?>
									</td>
								</tr>
								<tr>
								...
								<tr>
									<td colspan="2">
										...
										<table width="100%">
											...
											<tr>
												<td>
													<font size="5"><b><?php echo $latestMile1->title; ?></b></font>
												</td>
												<td>
													<font color="#5fbaff" size="5"><b><?php echo $currency_symbol . $latestMile1->budget; ?></b></font>
												</td>
											</tr>
											<tr>
												<td colspan="2">&nbsp;</td>
											...
											<tr>
												<td>&nbsp;</td>
												<td><br>
													<font size="5"><b><?php echo $lang['SUBTOTAL:']; ?></b>
														<font>&nbsp;&nbsp;&nbsp; <font color="#5fbaff" size="5"><b><?php echo $currency_symbol . $latestMile1->budget; ?></b></font>
												</td>
											</tr>
										</table>
										<br>
								...
								<tr>
									<td>
										<font color="#5fbaff"><?php echo $lang['Note']; ?></font>
									</td>
									<td>
										<font color="#5fbaff"><?php echo $company_name; ?></font>
									</td>
								</tr>
								<tr>
									<td>
						...
						<form method="post" class="milestonefrm1" action="#" enctype="multipart/form-data">
							...
							<div class="form-group">
								<div class="col-sm-12">
									...
									?>
									<input type="hidden" name="releaseDate" class="form-control datepicker releaseDate" required value="<?php if ($relDate) {
																																			echo $latestMile->releaseDate;
																																		} else {
																																			echo '1970-01-01';
																																		} ?>">
								</div>
							...
							<div class="form-group">
								<div class="col-sm-12">
									<div class="field-label"><label><?php echo $lang['Status']; ?></label></div>
									<label>
  <input type="radio" name="completed" value="1" onchange="document.querySelector('input[name=status2]').checked = false;">
  Completed
</label>
<label>
  <input type="radio" name="status2" value="0" checked>
							...
							<div class="row project-dash">
								<div class="col-lg-6 col-md-6 col-sm-6 mobileleft">
									<div class="pm-heading" style="width:100%;">
										<h2><?php echo $lang['Project Title:']; ?> <?php echo $ProjectsLoop[0]->project_title; ?> </h2><span><?php echo $lang['All Payment Milestones'] ?></span>
									</div>
								...
								<div class="col-lg-6 col-md-6 col-sm-6 creative-right text-right">
									<div class="mobilepromenu">
										...
										<div class="projmobilem">
											...
											<ul>
												<li class="cprojectmsg">
													<form action="../messages.php?project_id=<?php echo $ProjectsLoop[0]->p_id; ?>" method="post">
										...
										<tbody id="projects-tbl">
											...
											foreach ($recentProjects as $recentProject) { ?>
												...
												<tr>
													...
													<td class="inv-status"><?php if ($recentProject->status == 0) {
																				echo "<span class='label label-danger'>" . $lang['Unpaid'] . "</span>";
																			} else {
																				echo "<span class='label label-success'>" . $lang['Paid'] . "</span>";
																			} ?></td>
													<td class="invoice tbl-milestons">
...
if (isset($_POST['edit-milestone-1'])) {
	...
	if ($flag == 0) {
		...
		$mile->completed	= $_POST['completed'];
