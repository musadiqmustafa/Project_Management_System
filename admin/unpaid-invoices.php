...
<tr>
<td> 
<font size="2"><?php echo $lang['Thank you for business with us. We <br>feel great to help in you digital services.']; ?></font>
</td>
<td>
...
<div class="row project-dash">
            	<div class="col-sm-6">
				<div class="pm-heading" style="width:100%;"><h2><?php echo $lang['Unpaid Invoices']; ?> </h2><span><?php echo $lang['All unpaid Milestones']; ?></span></div>
				</div> 
...
$recentProjects=milestone::findBySql("select * from milestones where p_id='$milestons' and status=0 LIMIT $start_from, $limit");
$recentProjectsall=milestone::findBySql("select * from milestones where p_id='$milestons' and status=0");
