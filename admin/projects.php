						...
						<div class="row project-dash">
							<div class="col-lg-5 col-md-5 col-sm-5 project-opt mobileleft">
								<div class="pm-heading">
									<h2><?php echo $lang['Manage Project']; ?> </h2><span><?php echo $lang['All projects leads']; ?></span>
								</div>
								<div class="pm-form">
									...
									<tbody id="projects-tbl">
										...
										foreach ($recentProjects as $recentProject) { ?>
											...
											<tr>
												...
												<td class="tbl-ttl">
  <span class="onmobile">: </span>
  <a href="path/to/files/<?php echo $recentProject->file; ?>" class="btn btn-primary" download>Download</a>
</td>
														...
														<ul>
															...
															<li>
																<form method="post" action="#">
																	...
																	<input type="hidden" value="<?php if ($trash == 0) {
																									echo '1';
																								} else {
																									echo '0';
																								} ?>" name="del_val" />
															...
															<li>
																<form method="post" action="#">
																	...
																	<input type="hidden" value="<?php if ($status == 0) {
																									echo '1';
																								} else {
																									echo '0';
																								} ?>" name="comp_val" />
															...
															<li>
																<form method="post" action="#">
																	...
																	<input type="hidden" value="<?php if ($archive == 0) {
																									echo '1';
																								} else {
																									echo '0';
																								} ?>" name="arc_val" />
