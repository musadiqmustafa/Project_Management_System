											...
											<div class="cliproj-body">
												<div class="row">
													...
													<div class="col-md-3 cliproj-bodybox">
														...
														<div class="cliproj-bcont <?php if ($project_status == 0) {
													...
													<div class="col-md-3 cliproj-bodybox btnaligncls">
														...
														<div class="container">
														<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#projectModal" onclick="progress(<?php echo $project_pid; ?>)">View Progress</button>
...
<script>
 var projectChart; // declare the chart variable outside of the function
...
function progress(projectId) {
    ...
    $.ajax({
        ...
        success: function (data) {
			...
			var parsedData = JSON.parse(data);
var total = parsedData[0];
var completed = parsedData[1];
var uncompleted = parsedData[2];

var percentage = [
  (completed / total) * 100,
  (uncompleted / total) * 100
];
            ...
            projectChart = new Chart(ctx, {
                ...
                data: {
                    ...
                    datasets: [{
                        ...
                        data: [percentage[0], percentage[1]],
                        backgroundColor: [
                            'rgb(122,206,76)',
                            'rgb(46,158,255)'
                        ],
