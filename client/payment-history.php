...
$title = "Payment History | ". $syatem_title;
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
		...
		<form action="download_pdf.php" method="post" enctype="multipart/form-data" target="_blank">
...
<div class="row project-dash">
            	<div class="col-sm-6">
				<div class="pm-heading" style="width:100%;"><h2><?php echo $lang['Payment History']; ?> </h2><span><?php echo $lang['All Payment Milestones History']; ?></span></div>
				</div> 
...
$start_from_b = ($page-1) * $limit;	
		   $ProjectsLoop =projects::findBySql("select * from projects WHERE c_id= $id ORDER BY p_id DESC");
...
$sumvalall += count($recentProjectsall);
					  ...
					  ?>
                            ...
                            <tr>
                              ...
                              <td class="tbl-ttl"><span class="onmobile"><?php echo $lang['Title']; ?>: </span> <?php 
